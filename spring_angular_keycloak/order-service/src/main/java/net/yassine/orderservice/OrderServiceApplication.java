package net.yassine.orderservice;

import net.yassine.orderservice.entities.Order;
import net.yassine.orderservice.entities.OrderState;
import net.yassine.orderservice.entities.ProductItem;
import net.yassine.orderservice.repsoitories.OrderRepository;
import net.yassine.orderservice.repsoitories.ProductItemRepository;
import net.yassine.orderservice.restclients.InventoryRestClient;
